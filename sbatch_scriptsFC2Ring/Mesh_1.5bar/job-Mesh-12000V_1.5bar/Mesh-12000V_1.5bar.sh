...
JOBNAME="Mesh-12000V_1.5bar" #"Mesh"
PRESSURE=1.5 #bar
GASFILE="/scratch/llarizgoitia/GarfieldGaP/Electroluminescence/gases/ar_1.5bar" # gas file
MPHFILE="/scratch/llarizgoitia/GarfieldGaP/ComsolData/mesh_GaP3D_photoedge" #"mesh GaP3D"
DATAFILE="/scratch/llarizgoitia/GarfieldGaP/ComsolData/ELscan/electricpotentialGate-12000V" #"electricpotential GaP3D"
MATFILE="/scratch/llarizgoitia/GarfieldGaP/ComsolData/material_GaP3D" #"material GaP3D"
N_EVENTS=2000 #1

# Create the directory
cd /scratch/llarizgoitia/GarfieldGaP/sbatch_scripts_2ringFC/job_output_2ringFC/
